			...
			if (session != null) {
				...
				promises.push(
					BikeData.findAll({
						...
						console.log("DATE STRINGGGGGGGG 1: " + new Date(sessions[session].stampStart).toDateString())
						console.log("DATE STRINGGGGGGGG 2: " + new Date(parseInt(sessions[session].stampStart)).toDateString())
